                ...
                <div class="p-6 text-gray-900 bg-white">
                    <form method="POST" action="{{ route('clients.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="contact_name" :value="old('name')" required autofocus/>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_phone_number" class="block mt-1 w-full" type="text" name="contact_phone_number" required/>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_city" class="block mt-1 w-full" type="text" name="company_city" requireduired />
