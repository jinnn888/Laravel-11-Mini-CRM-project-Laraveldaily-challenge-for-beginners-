                ...
                <div class="p-6 text-gray-900 bg-white">
                    <form method="POST" action="{{ route('projects.update', $project->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description', $project->description)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-select name="user_id" :items="$users" :defaultVal="$project->id"/>
                        ...
                        <div class="mt-4">
                            ...
                            <x-select name="client_id" id="client" :items="$clients" :defaultVal="$project->client_id"/>
